...
<div class="w3-card-4" style="width:100%;">
	<header class="w3-container w3-blue"><h1>Udinra EDD Shop (Configuration)</h1></header>
	<div class="w3-panel w3-pale-blue w3-leftbar w3-rightbar w3-border-blue">
		<p>The Shop is refreshed daily.But in case you want to refresh it manually after product addition or deletion or any other changes like Price click below button</p>
	</div>
	<div class="w3-panel w3-pale-red w3-leftbar w3-rightbar w3-border-red">
		<p>A new button is added in Visual Editor. You can use the button to configure your shop.Use the Visual Editor on page you want to have the Shop.</p>
	</div>
    <form action="" method="post">
      <div class="w3-container">
		<input type="submit" class="w3-button w3-ripple w3-teal" name="save_option" id="save_option" value="Refresh Shop Manually" />	
		<a href="https://wordpress.org/plugins/udinra-easy-digital-downloads-shop/" class="w3-button w3-ripple w3-sand">Please rate this plugin on WordPress.org</a>
	</div>
	</form>
	<div class="w3-container">
		<div class="w3-row">
   ...
   <footer class="w3-container w3-blue">
		<p><?php echo "<h3>" . $udinra_edd_shop . "</h3>" ; ?></p>	
	</footer>	
</div>
<?php
?>